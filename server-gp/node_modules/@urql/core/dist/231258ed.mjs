...
function makeFetchSource(a, b, c) {
  return make((function(d) {
    ...
    Promise.resolve().then((function() {
      if (!p) {
        return g && (c.signal = g.signal), function A(a, b, c) {
          var e, d = !1;
          return (a.context.fetch || fetch)(b, c).then((function(a) {
            ...
            if ("AbortError" !== b.name) {
              return z(a, d ? Error(e.statusText) : b, e);
            }
          }));
        }(a, b, c);
      }
...
export { n as C, h as _, z as a, makeFetchBody as b, makeFetchURL as c, makeFetchOptions as d, makeFetchSource as e, createRequest as f, y as m, v as s };
//# sourceMappingURL=231258ed.mjs.map
